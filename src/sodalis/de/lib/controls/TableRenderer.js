sap.ui.define([
...
], function (ControlRenderer, Renderer, ColumnListItemRenderer, encodeXML) {
	"use strict";
	 ...
	 * @namespace
	 */
	var TableRenderer = Renderer.extend(ControlRenderer);
	...
	TableRenderer.renderColumns = function (rm, oTable, type) {
		...
		var index = 0,
			...
			hasOneHeader = (type == "Head") && aColumns.filter(oColumn => oColumn.getVisible() && !oColumn.isPopin() && !oColumn.isHidden()).length ==
			1,
